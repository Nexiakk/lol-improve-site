            ...
            {ROLE_ORDER.map(roleKey => {
                ...
                return (
                    <button
                        ...
                        className={`p-1 rounded-sm transition-all duration-150 focus:outline-none focus:ring-1 focus:ring-orange-400 flex items-center justify-center
...
function MatchHistoryHeader({
  ...
  const commonInputClass = "w-full bg-gray-700/80 border border-gray-600 rounded-md shadow-sm focus:ring-1 focus:ring-orange-500 focus:border-orange-500 text-gray-200 placeholder-gray-400 text-xs px-2.5";
